                                    ...
                                    <div class="row pb-3">
                                        <div class="col-sm-12 col-lg-6 pb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                   ...
                                                   maxlength="11" id="containerNumber" value="{{old('containerNumber')}}">
                                            {{-- Helper Text--}}
                                        ...
                                        <div class="col-sm-12 col-lg-6 pb-3">
                                            ...
                                            <input type="text" class="form-control" id="containerFinalDestination"
                                                   ...
                                                   placeholder="Enter Container Final Destination" value="{{old('containerFinalDestination')}}">
                                            {{-- Error message, will display if nothing has been input--}}
                                    ...
                                    <div class="row pb-4">
                                        <div class="col-sm-12 col-lg-6 pb-3">
                                            ...
                                            <input type="date" class="form-control" id="portDueDate" name="portDueDate"
                                                   min="" placeholder="Enter Port Due Date" value="{{old('portDueDate')}}">
                                            {{-- Error message, will display if nothing has been input--}}
                                            @error('portDueDate')
                                            <div class="alert alert-danger" role="alert">
                                                {{$message}}
                                        ...
                                        <div class="col-sm-12 col-lg-6 pb-3">
                                            ...
                                            <input type="date" class="form-control" id="warehouseDueDate"
                                                   ...
                                                   placeholder="Enter Warehouse Due Date" value="{{old('warehouseDueDate')}}">
                                            {{-- Error message, will display if nothing has been input--}}
                                    ...
                                    <div class="row pb-4">
                                        <div class="col-sm-12 col-lg-6 pb-3">
                                            ...
                                            <input type="number" class="form-control" id="shipperReferenceNumber"
                                                   ...
                                                   placeholder="Enter Shipper Reference Number" value="{{old('shipperReferenceNumber')}}">
                                            {{-- Error message, will display if nothing has been input--}}
                                        ...
                                        <div class="col-sm-12 col-lg-6 pb-3">
                                            ...
                                            <input type="number" class="form-control" id="shipperInvoiceNumber"
                                                   name="shipperInvoiceNumber" maxlength="11"
                                                   placeholder="Enter Shipper Invoice Number" value="{{old('shipperInvoiceNumber')}}">
                                            {{-- Error message, will display if nothing has been input--}}
                                    ...
                                    <div class="row pb-3">
                                        <div class="col-sm-12 col-lg-6 pb-3">
                                            ...
                                            <input type="number" class="form-control" id="shippingInvoiceValue"
                                                   ...
                                                   step=".01" value="{{old('shippingInvoiceValue')}}">
                                            {{-- Error message, will display if nothing has been input--}}
                                        ...
                                        <div class="col-sm-12 col-lg-6 pb-3">
                                            ...
                                            <input type="number" class="form-control" id="amountOfItemsInContainer"
                                                   ...
                                                   placeholder="Enter Amount of items in container" max="9999999" value="{{old('amountOfItemsInContainer')}}">
                                            {{-- Error message, will display if nothing has been input--}}
